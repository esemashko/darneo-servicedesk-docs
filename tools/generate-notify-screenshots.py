...
OUTPUT_DIR = (
    ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "tickets" / "general" / "notify"
)
...
TARGETS = [
    ScreenshotTarget(
        ...
        selector='[data-test="notify-table"]',
        filename="list.png",
        viewport_width=1600,
        viewport_height=760,
    ),
    ScreenshotTarget(
        ...
        selector=".p-dialog",
        filename="detail.png",
        click_selector='tr:has-text("Создание заявки") button[aria-label="Настроить"]',
        wait_selector='.p-dialog:has-text("Создание заявки")',
        viewport_width=1360,
