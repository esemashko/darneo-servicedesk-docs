...
OUTPUT_DIR = (
    ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "tickets" / "general" / "main"
)
...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-main-main-setting--with-settings",
        selector='[data-test="main-settings"]',
        filename="list.png",
        viewport_width=1400,
    ...
    ScreenshotTarget(
        ...
        selector='[data-test="main-settings"]',
        filename="edit.png",
        click_selector='[data-test="main-settings"] .link-edit',
        wait_selector='[data-test="main-settings"] .ui-btn-primary',
        viewport_width=1400,
        viewport_height=1050,
    ),
]
