...
OUTPUT_DIR = ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "tickets" / "sla"
...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-sla-rule-sla-rule--with-rules",
        selector='[data-test="sla-rule"]',
        filename="rule-list.png",
        viewport_width=1800,
        viewport_height=760,
    ),
    ScreenshotTarget(
        story_id="settings-sla-rule-sla-rule--with-rules",
        selector=".p-dialog",
        filename="rule-form.png",
        click_selector="button:has(.pi-pencil)",
        wait_selector='.p-dialog:has-text("ООО \\"Ромашка\\"")',
        viewport_width=1360,
        viewport_height=1200,
    ),
    ScreenshotTarget(
        story_id="settings-sla-schedule-sla-schedule--with-schedules",
        selector='[data-test="sla-schedule"]',
        filename="schedule-list.png",
        viewport_width=1600,
        viewport_height=820,
    ),
    ScreenshotTarget(
