...
OUTPUT_DIR = (
    ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "tickets" / "fields" / "ticket-tabs"
)
...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-ticket-tabs-setting-tabs--with-tabs",
        selector='[data-test="ticket-tabs"]',
        filename="list.png",
        viewport_width=1800,
        viewport_height=760,
    ),
    ScreenshotTarget(
        ...
        selector=".p-dialog",
        filename="form.png",
        click_selector='tr:has-text("Основное") button:has(.pi-pencil)',
    ...
    ScreenshotTarget(
        ...
        click_selector='tr:has-text("Основное") button:has-text("Колонки")',
        wait_selector='.p-drawer:has-text("Колонки вкладки")',
        viewport_width=1600,
    ...
    ScreenshotTarget(
        ...
        selector=".p-dialog",
        filename="filter.png",
        click_selector='tr:has-text("Основное") button:has-text("Фильтр")',
        wait_selector='.p-dialog:has-text("Настройка фильтра")',
        viewport_width=1360,
        viewport_height=900,
    ),
]
