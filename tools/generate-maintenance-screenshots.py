...
OUTPUT_DIR = ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "maintenance"
...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-maintenance-object-manager--with-objects",
        selector="#storybook-root",
        filename="object-list.png",
    ),
    ScreenshotTarget(
        story_id="settings-maintenance-object-manager--with-objects",
        selector=".p-dialog",
        filename="object-form.png",
        click_selector="button:has(.pi-pencil)",
        wait_selector=".p-dialog",
    ),
    ScreenshotTarget(
        story_id="settings-maintenance-scenario-manager--with-scenarios",
        selector='[data-test="scenario-details"]',
        filename="scenario-steps.png",
        viewport_height=1040,
    ),
    ScreenshotTarget(
        story_id="settings-maintenance-scenario-manager--with-scenarios",
        selector=".p-dialog",
        filename="scenario-step-form.png",
    ...
    ScreenshotTarget(
        ...
        selector="#storybook-root",
        filename="regulation-list.png",
    ),
    ScreenshotTarget(
        story_id="settings-maintenance-regulation-manager--with-regulations",
        selector=".p-dialog",
        filename="regulation-form.png",
        click_selector="button:has(.pi-pencil)",
        wait_selector=".p-dialog",
        viewport_width=1360,
    ...
    ScreenshotTarget(
        story_id="settings-maintenance-regulation-manager--with-regulations",
        selector='[data-test="regulation-readonly-preview"]',
        filename="regulation-preview.png",
        click_selector="button:has(.pi-pencil)",
        wait_selector='[data-test="regulation-readonly-preview"]',
        viewport_width=1360,
        viewport_height=1020,
    ),
]
