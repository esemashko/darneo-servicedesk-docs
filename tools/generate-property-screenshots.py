...
OUTPUT_DIR = (
    ROOT_DIR / "docs" / "assets" / "screenshots" / "settings" / "tickets" / "fields" / "property"
)
...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-property-property--with-properties",
        selector='[data-test="property-settings"]',
        filename="list.png",
        viewport_width=1800,
        viewport_height=760,
    ),
    ScreenshotTarget(
        ...
        selector=".p-dialog",
        filename="form.png",
        click_selector='button:has-text("Добавить поле")',
        wait_selector='.p-dialog:has-text("Новое поле")',
        viewport_width=1360,
        viewport_height=900,
    ),
    ScreenshotTarget(
        ...
        selector=".p-dialog",
        filename="enum.png",
        click_selector='tr:has-text("Причина обращения") button:has-text("Значения")',
        wait_selector='.p-dialog:has-text("Значения списка")',
        viewport_width=1360,
        viewport_height=900,
    ),
    ScreenshotTarget(
        ...
        click_selector='tr:has-text("Сумма ремонта") button:has-text("Настройки")',
        wait_selector='.p-dialog:has-text("Настройки поля")',
        viewport_width=1360,
        viewport_height=900,
    ),
]
