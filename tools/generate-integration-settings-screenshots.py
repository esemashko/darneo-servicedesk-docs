...
TARGETS = [
    ScreenshotTarget(
        story_id="settings-integration-mail-mail--with-mailboxes",
        selector='[data-test="integration-mail"]',
    ...
    ScreenshotTarget(
        ...
        / "mail"
        / "form.png",
        click_selector='tr:has-text("support@example.com") button:has(.pi-pencil)',
        wait_selector='.p-dialog:has-text("Редактирование почтового ящика")',
        viewport_width=1360,
