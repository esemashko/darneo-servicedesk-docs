...
Для Push на телефоне недостаточно включить переключатель в этой таблице: пользователь также должен разрешить уведомления в мобильном приложении Битрикс24. Порядок проверки указан на странице [Мобильное приложение](../../../start/mobile-application.md).
